    ...
    return (
        <div className="lg:pl-5 lg:pr-5 pl-0 pr-0 flex justify-between items-center bg-black  text-white text-2xl">
          ...
          <div className=" flex gap-1 bg-richblack-700 px-3  rounded-md">
            ...
            <input className=" border-none lg:w-[30vw] lg:px-5 lg:py-3 px:2 py:2 w-[10vw] bg-transparent rounded-lg text-white text-sm outline-none" type="text" value={searchvalue} placeholder="Search for anything" onChange={handler}></input>
