...
function Sidebar(){
  let {getdata}=useContext(Appcontext);
    return(
        <div className=" overflow-scroll lg:flex lg:flex-col lg:gap-2 lg:pt-28 lg:absolute  lg:bottom-0 lg:top-0 lg:-z-10  lg:justify-between lg:py-7 lg:px-2 font-bold lg:w-[15vw] flex bg-richblack-800 text-white" >
